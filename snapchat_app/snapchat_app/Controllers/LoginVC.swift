...
class LogInVC: UIViewController {
  ...
  lazy var imageView: UIImageView = {
    ...
    lazy var imageView2: UIImageView = {
      let imageView2 = UIImageView()
        imageView2.image = UIImage(named: "icon")
  ...
  override func viewDidLoad() {
    ...
    NSLayoutConstraint.activate([
      ...
      //Constraint imageView2
      view.addSubview(imageView2)
      NSLayoutConstraint.activate([
        imageView2.topAnchor.constraint(equalTo: view.topAnchor, constant: 150),
        imageView2.centerXAnchor.constraint(equalTo: view.centerXAnchor),
        imageView2.heightAnchor.constraint(equalToConstant: 250),
        imageView2.widthAnchor.constraint(equalTo: imageView2.heightAnchor,multiplier: 100/100)
      ])
