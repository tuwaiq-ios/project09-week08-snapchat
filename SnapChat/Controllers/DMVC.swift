...
class DMVC: MessagesViewController {
    ...
    private func customizeBar() {
        ...
        messageInputBar.inputTextView.layer.borderColor = UIColor.yellow.cgColor
        ...
        messageInputBar.sendButton.setTitleColor(.systemYellow, for: .normal)
        messageInputBar.sendButton.setTitleColor(
            UIColor.yellow.withAlphaComponent(0.3),
            for: .highlighted
        )
        
        //list to send photo video location
        
        let image = UIImage(systemName: "message")!.withTintColor(.yellow, renderingMode: .alwaysOriginal)
...
extension DMVC: MessagesDataSource, MessagesLayoutDelegate, MessagesDisplayDelegate, MessageCellDelegate{
...
extension DMVC: InputBarAccessoryViewDelegate  {
...
extension DMVC: CLLocationManagerDelegate {
